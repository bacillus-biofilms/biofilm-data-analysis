...
def preprocess_time_series_values(input_path, output_path, transform=True, double_zero_remove=True, interpolate=True):
    ...
    print("Number of genes with interpolated with one value: " + str(interpolated_one_value))
    print("Number of genes with interpolated with two values: " + str(interpolate_two_values))
